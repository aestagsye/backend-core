...
public class LeadProcessor {
  ...
  public void methodRequired() {
    logTx("REQUIRED");
    Lead lead = new Lead("required+" + System.nanoTime()
            + "@test.com", "Required Corp", LeadStatus.NEW);
  ...
  public void methodRequiredNew() {
    logTx("REQUIRES_NEW");
    Lead lead = new Lead("required-new+" + System.nanoTime() + "@test.com",
            "Requires New Corp", LeadStatus.NEW);
    leadRepository.save(lead);
  ...
  public void methodMandatory() {
    logTx("MANDATORY");
    Lead lead = new Lead("mandatory+" + System.nanoTime() + "@test.com",
            "Mandatory Corp", LeadStatus.NEW);
    leadRepository.save(lead);
  }
